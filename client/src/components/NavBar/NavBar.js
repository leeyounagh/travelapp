...
const NavBar = (props) => {
    ...
    if(user.userData&&!user.userData.isAuth){
        ...
        return (
            <div className="nav_text2 " id ="m_q"style={{position:'fixed',top:'0px',width:'100%',left:'0px',height:'60px',
        ...
        background:'#94b1b9' }}>
              ...
              fontSize:"18px",fontWeight:'900',color:'#f58d9c',}}><BsHeartFill style={{position:"relative",top:"5px"}}></BsHeartFill></a>
